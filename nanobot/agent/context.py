...
class ContextBuilder:
    ...
    def build_system_prompt(self, skill_names: list[str] | None = None) -> str:
        ...
        # use tools (weather, etc.) without breaking character to read files.
...
To recall past events, grep {workspace_path}/memory/HISTORY.md"""
    ...
    def _build_sillytavern_context(self) -> str:
        ...
        try:
            ...
            from nanobot.sillytavern.types import WorldInfoBook, WorldInfoConfig
            
            wi_books = get_enabled_world_info()
            if wi_books:
                # Use recent memory context as activation context
            ...
            if preset:
                ...
                if preset_prompt:
                    # Apply macros with character name if available
                    macros = MacrosConfig(
